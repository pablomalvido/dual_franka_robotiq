...
class NordboSensor(Node):
    def __init__(self, prefix, ns):
        ...
        self.tare_srv = self.create_service(Trigger, self.ns+'/'+self.prefix+'nordbo/tare', self.tare_callback)
        self.abs_srv = self.create_service(Trigger, self.ns+'/'+self.prefix+'nordbo/absolute', self.abs_callback)
    ...
    def init_sensor(self):
        ...
        #print("Connection stablished with " + self.ip_address + ":" + str(self.port))
        self.get_logger().info("Connection stablished with norbdo force sensor at " + self.ip_address + ":" + str(self.port))
