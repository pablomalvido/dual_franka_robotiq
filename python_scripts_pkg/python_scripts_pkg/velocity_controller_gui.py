...
class Vector3Publisher(Node):
    def __init__(self):
        super().__init__('vector3_gui_publisher')
        self.publisher_ = self.create_publisher(Vector3, '/cartesian_velocity_example_controller/target_speed', 10)
...
class Vector3GUI(QWidget):
    def __init__(self, ros_node):
        ...
        self.setWindowTitle('Velocity Vector3 Publisher GUI')
    ...
    def update_value(self, axis, value):
        float_val = value / 10000.0  # Scale from -0.04 to 0.04
