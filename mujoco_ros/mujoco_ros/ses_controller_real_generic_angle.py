...
class ChainErgodicServoingProgressDriven(Node):
    ...
    def __init__(self,
                 ...
                 max_steps=1500,
                 num_modes=15,
                 config_file='ses_controller_real_exp5_v2.yaml'):
    ...
    def _marker_angle_cb(self, msg: Float64):
    ...
    def step(self):
        ...
        #     real_dist_sum += dist
        angle_err = abs(self.current_angle_deg - self.target_angle_deg)
        
        lik_val = 1.0 / (1.0 + angle_err / (2.0 * self.sigma_likelihood**2)) #y(x(t)) in the paper. How likely is to accomplish the task in this x
        ...
        self.metric_history.append(angle_err)
        ...
        self.logs["error"].append(angle_err)
        ...
        self.logs["r_feat"].append(self.current_angle_deg)
        self.logs["r_targ"].append(self.target_angle_deg)
        if self.iter % 30 == 0:
