 ...
 */
class CartesianVelocityControllerSES : public controller_interface::ControllerInterface {
 public:
 ...
 private:
  ...
  bool vel_target_ = {true};
  const double max_x_displacement_ = 0.3;
  const double max_x_pos_ = 0.75;
};
